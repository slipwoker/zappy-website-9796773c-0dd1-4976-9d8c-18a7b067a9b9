document.addEventListener('DOMContentLoaded', function () {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (type === 'email' && !isValidEmail(value)) {
          ...
          errorMessage = field.dataset.errorUrl || 'Please enter a valid URL.';
          ...
          if (value.length > maxLength) {
            errorMessage = field.dataset.errorMaxlength || ('Maximum ' + maxLength + ' characters allowed.');
          }
        }
      }
  ...
  function clearFormErrors(form) {
    ...
    form.querySelectorAll('.field-error, .field-valid').forEach(function (field) {
  ...
  function handleFormSuccess(form) {
    ...
    form.querySelectorAll('.field-valid').forEach(function (field) {
      field.classList.remove('field-valid');
    });
...
function updateVariantUI(variant, product, t, selectedAttributes) {
  ...
  if (variant) {
    ...
    if (customerDiscountConfig && product && product.id) {
      var custAdjDetail = applyCustomerPercentToPrice(displayedFinalPrice, product.id);
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '9796773c-0dd1-4976-9d8c-18a7b067a9b9',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '9796773c-0dd1-4976-9d8c-18a7b067a9b9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9796773c-0dd1-4976-9d8c-18a7b067a9b9';
